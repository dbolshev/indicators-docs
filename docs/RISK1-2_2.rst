#####################################################################################################
RISK-1-2-2. Закупівля робіт понад "європейські пороги" проведена з порушенням порядків розгляду, розкриття та електронного аукціону (Закупівля робіт кваліфікується як відкриті торги (EU), але замовником обрана інша процедура)
#####################################################################################################
